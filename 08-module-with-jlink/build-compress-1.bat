...
%JAVA_HOME%/bin/jlink --module-path out/;%PATH_TO_FX_MODS% --add-modules packt.addressbook.ui --bind-services --compress=1 --output image-compress-1
cmd /c echo F | xcopy input.xml image-compress-1\
